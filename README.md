...
[Claude Code Playbook](https://docs.claude-hunt.com) 강의의 실습용 저장소입니다. Next.js 와 shadcn/ui 로 구축한 Todo 앱을 단계별로 발전시키며 Claude Code 사용법을 익힙니다.

- **프레임워크**: Next.js App Router 기반의 풀스택 Todo 앱
- **목적**: Claude Code를 활용한 AI 페어 프로그래밍 실습
- **구성**: 챕터별 브랜치로 단계적 진행
